...
s.name         = "CSTools"
s.version      = "0.0.1"
s.summary      = "CSTools.Integration of some commonly used tools and controls,Write it casually."
...
#   * 不用担心缩进,CocoaPods吧!
s.description  = <<-DESC
CSTools.Integration of some commonly used tools and controls,Write it casually,Look at yourself.
DESC

s.homepage     = "https://github.com/liuconglaile/CSTools"
...
s.source       = { :git => "https://github.com/liuconglaile/CSTools.git", :tag => "#{s.version}" }
